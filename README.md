...
### Установка словарей в программе portable-версии KoobAudio 
...
### Установка словарей в программе установочной версии KoobAudio
...
1. перейти в папку пользователя:
 ...
 #### Принцип обработки текста правилами
 Словарь состоят из отдельных словарей-правил (далее под "словарём" будут подразумеваться только отдельные словари - правила), разделённых по тематике или каким-либо принципам, и иммет чёткую структуру обработки текста. Такое разделение упрощает составление правил и уменьшает количество двойных ошибок при обработке текста (когда слово обрабатывается схожими правилами два и более раз).
 В словарях записаны правила идущие по порядку сверху вниз. Программа "пропускает" каждое слово (символ) через правила, указзанные в словарях, по порядку расположения правил в словаре, и вносит изменения в проверяемое слово (символ), если таковое имеется.
 ...
 Программа имеет ряд отличительнеых особенностей обработки текста. 
 1. 
 2. От порядка расположения словарей в папках зависит 
